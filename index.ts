...
// -- Personal info -----------------------
const project: keyof typeof projectIds = process.env
  .PROJECT as unknown as keyof typeof projectIds; // project of your choice which should match projectIds properties
...
(async () => {
  try {
    ...
    const array: Data[] = [];
    let index = 0;
    let dataArraySplitByNewLine: string[] = timeTrackData
      .split(/\r?\n/)
      .filter(Boolean);
    let object: Data = { ...resetObject } as Data;
